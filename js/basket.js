...
let shoppingCart = JSON.parse(localStorage.getItem("shoppingCart")); //shoppingCart au global pour simplicité
console.table(shoppingCart); //pour test

let cameraData = JSON.parse(localStorage.getItem("cameraData")); //cameraData au global pour simplicité
...
`;
  ...
  document.querySelector("#grandTotal").innerHTML = priceConversion(grandTotal);
